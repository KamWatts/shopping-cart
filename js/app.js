...
Cart.prototype.saveToLocalStorage = function () {
  ...
  let cartData = JSON.stringify(this.items)
...
Cart.prototype.removeItem = function (item) {
  ...
  // let cartDataBackFromLocal = localStorage.getItem(`cartItemsData`)
  // if (cartDataBackFromLocal) {
  //   let parsedCartData = JSON.parse(cartDataBackFromLocal)
